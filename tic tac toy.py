...
def BuClick(id):
    ...
    if (ActivePlayer==1):
        setLayout(id,'x')
        p1.append(id)
        root.title("Tic Tac Tay : Player 2")
        ActivePlayer=2
        print('p1:{}'.format(p1))
        ...
        setLayout(id,'o')
        p2.append(id)
        root.title("Tic Tac Tay : Player 1")
        ActivePlayer=1
        print('p2:{}'.format(p2))
    CheckWiner()
...
def CheckWiner():
    ...
    if Winer==1:
         messagebox.showinfo(title='Cong.',message='Abdu is the winer')

    if Winer==2:
        messagebox.showinfo(title='Cong.',message='Debi is the winer')
